...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <div class="subheader">
            ...
            <div>
                <h4 id="headernamedata">
                    <xsl:attribute name="ng-bind"> '<xsl:value-of
                            select="concat(../@viewid,'.','headername')" />' | translate </xsl:attribute>
                </h4>
            </div>
            <p id="headerdescriptiondata">
                <xsl:attribute name="ng-bind"> '<xsl:value-of
                        select="concat(../@viewid,'.','headerdescription')" />' | translate </xsl:attribute>
            </p>
        </div>
        <!--<hr
        />-->
            ...
            <div class="alert alert-danger">
                <xsl:if test="@ifcondition">
                    <xsl:attribute name="ng-show">
                        <xsl:value-of
                            select="concat(translate(translate(@objectname,'*',''),'.',''),'messagepopup')" />
                    </xsl:attribute>
                    <xsl:attribute name="ng-init">
                        <xsl:value-of
                            select="concat('checkWarningMessageCondition(&quot;', @ifparam, '&quot;,&quot;', @ifcondition, '&quot;,&quot;', @ifvalue, '&quot;,&quot;', @url, '&quot;,&quot;' , @polling, '&quot;,&quot;', @interval ,'&quot;,&quot;', concat(translate(translate(@objectname,'*',''),'.',''),'messagepopup'),'&quot;)')" />
                    </xsl:attribute>
                </xsl:if>
                        ...
                        <xsl:choose>
                            <xsl:when test="contains(@dependsonparamvalue, ',')">
                                <xsl:call-template name="multiplevalues">
                                    ...
                                    <xsl:with-param name="dependsobjectname"
                            ...
                            <xsl:otherwise>
                                <xsl:value-of
                                    select="concat(translate(translate(@dependsonobject,'.',''),'*',''),'.',@dependsonparam,'==',@dependsonparamvalue)" />
                            </xsl:otherwise>
                        </xsl:choose>
                ...
                <xsl:attribute name="ng-click">
                            <xsl:value-of
                select="concat('popupclose(&quot;',translate(translate(@objectname,'*',''),'.',''),'messagepopup','&quot;)')"/>
                </xsl:attribute>&#10006;
            </a>-->
                <p>
    ...
    <xsl:template name="label">
        <div class="row">
            <label for="{@name}" class="col-sm-12 col-lg-12 col-md-12 col-xs-12 control-label">
                <xsl:attribute name="ng-bind">'<xsl:value-of select="concat(../@name,'.',@webname)" />'
        ...
        <div>
            ...
            <xsl:if test="@parent">
                <xsl:attribute name="ng-if">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:value-of
                                select="concat(translate(translate(@parentname,'.',''),'*',''),'.',@depends,'==',@parent)" />
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <xsl:if test="@description">
                <div class="row">
                    ...
                    <span
                        class="col-lg-offset-3  col-md-offset-3 col-sm-12 col-lg-6 col-md-6 col-xs-12 descrip_txt">
                        <xsl:attribute name="ng-bind"> '<xsl:value-of
                                select="concat($paramobjectname,'.',@webname,'.',@description)" />'
                            | translate </xsl:attribute>
                    </span>
                </div>
            </xsl:if>
            <div class="row">
                <div>
                    ...
                    <xsl:if test="@polling and @interval">
                        <xsl:attribute name="ng-init">
                            <xsl:value-of
                                select="concat('PollingForParameter(&quot;',$paramobjectname, '&quot;,&quot;',@name,'&quot;, &quot;', @interval,'&quot;)')" />
                        </xsl:attribute>
                    </xsl:if>
                    <input type="text" class="form-control hidden-dom-removal" id="{@name}">
                        <xsl:if test="@disabledonparamvalue">
                            <xsl:attribute name="ng-disabled">
                                ...
                                <xsl:value-of
                                    select="concat(translate(translate(@disabledonobject,'.',''),'*',''),'.',@disabledonparam,'==',@disabledonparamvalue)" />
                        ...
                        <xsl:attribute name="placeholder">
                            <xsl:choose>
                                <xsl:when test="@placeholder">
                                    <xsl:choose>
                                        <xsl:when test="$paramobjectpreviousname=''"> {{'<xsl:value-of
                                                select="concat($paramobjectname,'.',@webname,'.','placeholder')" />'
                                            | translate}} </xsl:when>
                                        <xsl:otherwise> {{'<xsl:value-of
                                                select="concat($paramobjectpreviousname,'.',@webname,'.','placeholder')" />'
                                            | translate}} </xsl:otherwise>
                                    </xsl:choose>
                        ...
                        <xsl:if test="not(@Display) and (not(@required) or @required !='false')">
                            <xsl:attribute name="ng-required">
                                <xsl:choose>
                                    <xsl:when
                                        test="$parentobjectparentstatus=true and $parentobjectparentnamestatus=true  and  $parentobjectdependsstatus=true">
                                        <xsl:value-of
                                            select="concat(translate(translate($parentobjectparentname,'.',''),'*',''),'.',$parentobjectdepends,'==',$parentobjectparent)" />
                                    </xsl:when>
                                    <xsl:when
                                        test="@dependsonparamvalue and @dependsonobject  and  @dependsonparam">
                                        <xsl:choose>
                                            <xsl:when test="contains(@dependsonparamvalue, ',')">
                                                <xsl:call-template name="multiplevalues">
                                                    <xsl:with-param name="list"
                                                        select="@dependsonparamvalue" />
                                                    <xsl:with-param name="delimiter" select="','" />
                                                    <xsl:with-param name="dependsobjectname"
                                                        select="@dependsonobject" />
                                                    <xsl:with-param name="dependsparamname"
                                                        select="@dependsonparam" />
                                                </xsl:call-template>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:value-of
                        ...
                        <xsl:attribute name="name">
                            ...
                            select="@name"/>-->
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name)" />
                        </xsl:attribute>
                        <xsl:attribute name="ng-model">
                            <!--                         <xsl:value-of
                            select="concat(translate($paramobjectname,'.','_'),'.',@name)"/>-->
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'.',@name)" />
                        </xsl:attribute>
                        <xsl:if test="@Value">
                            ...
                            <xsl:attribute name="ng-init">
                                <xsl:value-of
                                    select="concat('defaultvalue(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'&quot;,&quot;',@name,'&quot;,&quot;',@Value,'&quot;)')" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:attribute name="ng-blur">
                            <xsl:value-of
                                select="concat('textChange(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'__',@name,'&quot;,',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,')')" />

                        </xsl:attribute>
                        <xsl:if test="@getObject">
                            <xsl:attribute name="ng-change">
                                <!-- <xsl:value-of
                                select="concat(translate(../@name,'.','_'),'.',@name)"/>-->
                                <xsl:value-of
                                    select="concat('resetValue(&quot;',@child,'&quot;,&quot;',@name,'&quot;,&quot;',concat(translate(translate($paramobjectname,'*',''),'.',''),'.',@name), '&quot;)')" />
                            </xsl:attribute>
                        </xsl:if>
                    </input>
                    <label for="{@name}">
                        <xsl:attribute name="class">
                            <xsl:choose>
                                <xsl:when
                                    test="not(@Display) and (not(@required) or @required !='false')">
                                    required row active
                                </xsl:when>
                                <xsl:otherwise>
                                    active
                        ...
                        <xsl:attribute name="ng-bind"> '<xsl:value-of
                                select="concat($paramoriginalobjectname,'.',@webname)" />' |
                            translate </xsl:attribute>
                    </label>

                    <xsl:if test="@HasSuffix='Yes'">
                        <span class="suffix">
                            <xsl:value-of select="@SuffixData" />
                        </span>
                    </xsl:if>
                    <xsl:if test="@description">
                        <span class="help_btn">
                    ...
                    <span class="error">
                        <xsl:attribute name="ng-show">
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name,'responsestatus')" />
                        </xsl:attribute>
                        <xsl:attribute name="ng-bind">
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name,'val')" />
                            |translate </xsl:attribute>
                    </span>
                    <xsl:if test="not(@Display) and (not(@required) or @required !='false')">
                    ...
                    <xsl:if test="@minlen">
                        <xsl:call-template name="minErrorMessage">
                            <xsl:with-param name="FormName" select="$formname" />
                            <xsl:with-param name="objectname" select="$paramobjectname" />
                            <xsl:with-param name="originalObjectname"
                                select="$paramoriginalobjectname" />
                            <xsl:with-param name="paramname" select="@name" />
                            <xsl:with-param name="webname" select="@webname" />
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 input-field">
                    ...
                    <label for="{@name}">
                        ...
                        <!--<xsl:attribute
                        name="ng-class">{active:<xsl:value-of
                        select="concat(translate(translate($paramobjectname,'*',''),'.',''),'.',@name)"/>}</xsl:attribute>-->
                        <xsl:attribute name="ng-bind"> '<xsl:value-of
                                select="concat($paramoriginalobjectname,'.',@webname)" />' |
                            translate </xsl:attribute>
                    </label>
                    ...
                    <span class="error">
                        ...
                        <xsl:attribute
                            ...
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name)" />
                        this is it <xsl:text>val</xsl:text>
                        </xsl:attribute>
                        <xsl:attribute
                            name="ng-show">
                        ...
                        </xsl:attribute> Invalid
                        pattern , Example mac address : 00:15:E9:2B:99:3C </span>
                    <span class="error">
                        <xsl:attribute name="forname">
                            <xsl:value-of
                                select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name)" />
    ...
    <xsl:template name="url">
        ...
        <div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 input-field">
                    <input xmltype="{@type}" type="text" class="form-control hidden-dom-removal"
                        id="{@name}">
                        <xsl:attribute name="placeholder">
                            <xsl:choose>
                                <xsl:when test="@placeholder">
                    ...
                    <span class="error">
                        <xsl:attribute name="ng-show">
                            <xsl:value-of
                                select="concat(translate(translate(../@name,'*',''),'.',''),'_',@name,'responsestatus')" />
                        </xsl:attribute>
                        <xsl:attribute name="ng-bind">
                            <xsl:value-of
                                select="concat(translate(translate(../@name,'*',''),'.',''),'_',@name,'val')" />
                            |translate </xsl:attribute>
                    </span>
                    <span class="error">
                        <xsl:attribute name="forname">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 input-field">
                    ...
                    <span class="error">
                        ...
                        <xsl:attribute name="ng-bind">
                            'Invalid pattern,Example IPv6 address :
                            FE80:0000:0000:0000:0202:B3FF:FE1E:8329' | translate
                        </xsl:attribute>
                    </span>
                    <xsl:if test="@description">
                        <span class="help_btn">
    ...
    <xsl:template name="multi-checkbox">
        ...
        <div class="form-group multicheckbox">
            <div class="row">
                <label for="{@name}"
                    class="col-sm-12 col-md-3 col-lg-3 control-label multi-checkbox-label">
                    <xsl:attribute name="ng-bind">'<xsl:value-of
                            select="concat($paramoriginalobjectname,'.',@webname)" />' | translate</xsl:attribute>
                </label>
                    ...
                    <div class="checkbox-scroll-vr">
                        ...
                        <xsl:choose>
                            <xsl:when test="@url">
                                <xsl:attribute name="ng-init">
                                    <xsl:value-of
                                        select="concat('checkboxurl(&quot;',@url,'&quot;,&quot;',@name,'&quot;,&quot;',@urlparam,'&quot;,&quot;',@mappedvalue,'&quot;,&quot;',@allchecked,'&quot;)')" />
                                </xsl:attribute>
                            </xsl:when>
                            <xsl:when test="@fakeurl">
                                <xsl:attribute name="ng-init">
                                    <xsl:value-of
                                        select="concat('checkboxurl(&quot;',@fakeurl,'&quot;,&quot;',@name,'&quot;,&quot;',@urlparam,'&quot;)')" />
                                </xsl:attribute>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:attribute name="ng-init">
                                    <xsl:value-of
                                        select="concat(@name,'=','&quot;',@validvalues,'&quot;')" />
                                </xsl:attribute>
                            </xsl:otherwise>
                        </xsl:choose>
                        <p>
                            <xsl:choose>
                                <xsl:when
                                    test="(@urlparam or not(contains(@url,'cgi_get'))) and not(@validvalues)">
                                    <xsl:attribute name="ng-repeat"> role in <xsl:value-of
                                            select="@name" />
                                    </xsl:attribute>
                                </xsl:when>
                                <xsl:otherwise>
                            ...
                            <input type="checkbox">
                                <xsl:attribute name="id">
                                    <xsl:value-of select="@name" />{{$index+1}} </xsl:attribute>
                                <xsl:choose>
                                    <xsl:when
                                        test="(@urlparam or not(contains(@url,'cgi_get'))) and not(@validvalues)">
                                        <xsl:attribute name="checklist-model">
                                            <xsl:value-of
                                                select="concat('getRoles(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,'&quot;,&quot;true','&quot;)')" />
                                        </xsl:attribute>
                                    </xsl:when>
                                    <xsl:when test="@fakeurl">
                                        <xsl:attribute name="checklist-model">
                                    ...
                                    <xsl:otherwise>
                                        <xsl:attribute name="checklist-model">
                                            <xsl:value-of
                                                select="concat('getRoles(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,'&quot;)')" />
                                        </xsl:attribute>
                                    </xsl:otherwise>
                                </xsl:choose>
                                <xsl:choose>
                                    ...
                                    <xsl:when
                                        ...
                                        <xsl:attribute name="ng-change">
                                            <xsl:value-of
                                                select="concat('check(','role',',checked',',&quot;',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,'&quot;,&quot;true','&quot;)')" />
                                        </xsl:attribute>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:attribute name="ng-change">
                                            <xsl:value-of
                                                select="concat('check(','role',',checked',',&quot;',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,'&quot;)')" />
                                        </xsl:attribute>
                                    </xsl:otherwise>
                                </xsl:choose>
    ...
    <xsl:template name="wepkey">
        ...
        <div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 pwdblock"
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10 col-xs-10 input-field">
                        <input type="password" class="form-control hidden-dom-removal">
                            ...
                            <xsl:attribute name="ng-init">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'fieldstatus','=false')" />
                            </xsl:attribute>
                            <xsl:choose>
...
-->
                        ...
                        <xsl:if test="not(@Display) and (not(@required) or @required !='false')">
                            <xsl:call-template name="requiredErrorMessage">
                                <xsl:with-param name="FormName" select="$formname" />
                                <xsl:with-param name="objectname" select="$paramobjectname" />
                                <xsl:with-param name="originalobject"
                                    select="$paramoriginalobjectname" />
                                <xsl:with-param name="paramname" select="@name" />
                                <xsl:with-param name="webname" select="@webname" />
                            </xsl:call-template>
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2 col-xs-2 pwdtoggle">
                        <input type="checkbox">
                            <xsl:attribute name="id">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'checkbox')" />
                            </xsl:attribute>
                            <xsl:attribute name="ng-model">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'fieldstatus')" />
                            </xsl:attribute>
                            <xsl:attribute name="ng-change">
                                <xsl:value-of
                                    select="concat('passchange(&quot;',translate(translate($paramobjectname,'*',''),'.',''),@name,'&quot;)')" />
                            </xsl:attribute>
                        </input>
                        <label>
                            <xsl:attribute name="ng-class">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'fieldstatus')" />==true
                                ? 'hidepw checkbox_right_align' : 'showpw checkbox_right_align' </xsl:attribute>
                            <xsl:attribute name="for">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'checkbox')" />
                            </xsl:attribute>
...
-->
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xs-2 pwdtoggle">
                                ...
                                <label>
                                    <xsl:attribute name="ng-class">
                                        <xsl:value-of
                                            select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'fieldstatus')" />==true
                                        ? 'hidepw checkbox_right_align' : 'showpw
                                        checkbox_right_align' </xsl:attribute>
                                    <xsl:attribute name="for">
                                        <xsl:value-of
                                            select="concat(translate(translate($paramobjectname,'*',''),'.',''),@name,'checkbox')" />
                                    </xsl:attribute>
    ...
    <xsl:template name="hyperlink">
        <div class="col-sm-12 col-md-6 col-lg-12 col-xs-12" style="text-align:center;">
            ...
            <h4>
                <a href="#">
                    <xsl:attribute name="ng-bind">'<xsl:value-of
                            select="concat(../@originalobject,'.',@webname)" />' | translate</xsl:attribute>
                </a>
            </h4>
        </div>
    </xsl:template>
        ...
        <div class="input-field">
            <div>
                <input type="text" class="form-control" id="{@name}">
                    ...
                    <xsl:attribute name="ng-model">
                        <xsl:value-of
                            select="concat(translate(translate(../@name,'*',''),'.',''),'.',@name)" />
                    </xsl:attribute>
                    <xsl:attribute name="name">
                    ...
                    <xsl:attribute name="ng-blur">
                        <xsl:value-of
                            select="concat('textChange(&quot;',translate(translate(../@name,'*',''),'.',''),'__',@name,'&quot;,',translate(translate(../@name,'*',''),'.',''),'.',@name,')')" />
            ...
            <div>
                <input type="text" class="form-control" id="{@name}">
                    ...
                    <xsl:attribute name="name">
                        <!--  <xsl:value-of select="concat(translate(../@name,'.','_'),'.',@name)"/>  -->
                        <xsl:value-of
                            select="concat(translate(translate(../@name,'*',''),'.',''),'_',@name)" />
                    </xsl:attribute>
                    <xsl:attribute name="ng-blur">
                        <xsl:value-of
                            select="concat('textChange(&quot;',translate(translate(../@name,'*',''),'.',''),'__',@name,'&quot;,',translate(translate(../@name,'*',''),'.',''),'.',@name,')')" />
    ...
    <xsl:template name="number">
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 input-field">
                    <input type="number" class="form-control string-to-number hidden-dom-removal"
                        id="{@name}">
                        <xsl:attribute name="placeholder">
                            <xsl:choose>
                                <xsl:when test="@placeholder">
                        ...
                        <xsl:choose>
                            <xsl:when test="@exceptionvalue">
                                <xsl:attribute name="ng-blur">
                                    <xsl:value-of
                                        select="concat('textChange(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'__',@name,'&quot;,',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,');checkValidity(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'__',@name,'&quot;,',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,',&quot;', @exceptionvalue,'&quot;,&quot;', @maxval ,'&quot;,&quot;', @minval,'&quot;,&quot;', $formname ,'&quot;)')" />
                                </xsl:attribute>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:attribute name="ng-blur">
                    ...
                    <span class="error">
                        ...
                        {{'validnumbermessage' | translate }} </span>
                    <xsl:if test="@minval">
                        <span class="error">
                            <xsl:attribute name="forname">
                                <xsl:value-of
                            ...
                            <!--{{'minnumbervalmessage'
                            | translate }} <xsl:value-of select="@minval" />-->
                            <span>
                                <xsl:attribute name="ng-bind"> '<xsl:value-of
                                        select="concat($paramoriginalobjectname,'.',@webname,'.$error','.minval')" />
                                    '|translate
                                </xsl:attribute>
                            </span>
                            <span>
                    ...
                    <xsl:if test="@maxval">
                        <span class="error">
                            ...
                            <!--{{'maxnumbervalmessage'
                            | translate }} <xsl:value-of select="@maxval" />-->
                            <span>
                                <xsl:attribute name="ng-bind"> '<xsl:value-of
                                        select="concat($paramoriginalobjectname,'.',@webname,'.$error','.maxval')" />
                                    '|translate
                                </xsl:attribute>
                            </span>
                            <span>
    ...
    <xsl:template name="button1">
        ...
        <div class="btn-align">
            <input type="button" class="waves-effect waves-light btn btn-info" id="{@name}">
                <xsl:attribute name="value"> {{'<xsl:value-of select="@webname" />' | translate }} </xsl:attribute>
    ...
    <xsl:template name="button2">
        <xsl:param name="param" />
        <div class="btn-align col-lg-offset-8 col-md-offset-8"
            style="position:absolute;left:30px;bottom:0px">
            <input type="button" class="waves-effect waves-light btn btn-info" id="{@name}">
                <xsl:attribute name="value">
                    <xsl:value-of select="@webname" />
                </xsl:attribute>
    ...
    <xsl:template name="button">
        ...
        <div class="btn-align custom_btn">
            ...
            <xsl:if test="@dependsonparam and @dependsonobject">
                <xsl:attribute name="ng-show">
                    <xsl:value-of
                        select="concat(translate(translate(@dependsonobject,'.',''),'*',''),'.',@dependsonparam)" />
                </xsl:attribute>
            </xsl:if>
            <input type="button" class="waves-effect waves-light btn btn-info " id="{@name}">
                <xsl:attribute name="value"> {{'<xsl:value-of select="@webname" />' | translate }} </xsl:attribute>
                    ...
                    <select class="dropdown-toggle form-control1 hidden-dom-removal" id="{@name}">
                        <xsl:if test="@ifparam and @ifvalue and @ifcondition">
                            <xsl:attribute name="filterData">
                                <xsl:value-of
                                    select="concat(@name,'?',@ifparam,'__',@ifvalue,'__',@ifcondition)" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:if test="@disabledonparamvalue">
                            <xsl:attribute name="ng-disabled">
                        ...
                        <xsl:if test="@disable">
                            <xsl:attribute name="ng-disabled">
                                <xsl:value-of
                                    select="concat('!',translate(translate(@dependsonparamvalue,'*',''),'.',''),'.',@disable)" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:if test="@disable">
                            <xsl:attribute name="ng-disabled">
                                <xsl:value-of
                                    select="concat('!',translate(translate(@parent,'*',''),'.',''),'.',@disable)" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:attribute name="name">
                            <xsl:value-of
                        ...
                        <xsl:attribute name="ng-change">
                            <xsl:choose>
                                <xsl:when test="@ddfun">
                                    <xsl:value-of
                                        select="concat(@ddfun,'(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',@child,'&quot;,','&quot;',@childparam,'&quot;)')" />
                                </xsl:when>
                                <xsl:when test="@customfun">
                                    <xsl:value-of
                                        select="concat('wifi(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'__',@name,'&quot;,&quot;',@customfun,'&quot;,',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,')')" />
                                </xsl:when>
                                ...
                                <xsl:otherwise>
                                    <xsl:value-of
                                        select="concat('ddChange(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'__',@name,'&quot;,',translate(translate($paramobjectname,'*',''),'.',''),'.',@name,')')" />
                                </xsl:otherwise>
                            </xsl:choose>
                        </xsl:attribute>
                        <xsl:if test="@customfun">
                            <xsl:attribute name="ng-options">
                                <xsl:value-of
                                    select="concat('obj.id as obj.name for obj in ', @name)" />
                                <xsl:if test="@order">
                                    |orderBy:'name'
                                </xsl:if>
                            </xsl:attribute>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="@xmlvalidation and @validvalues">
                                <xsl:attribute name="ng-init">
                                    <xsl:value-of
                                        select="concat('depenencyUrl(&quot;',translate(translate($paramobjectname,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,&quot;',@dependentparams,'&quot;,&quot;',$formname,'&quot;,&quot;',@validvalues,'&quot;)')" />
                                </xsl:attribute>
                                <xsl:attribute name="ng-options">
                                    <xsl:value-of
                                        select="concat('obj.id as obj.name for obj in ', @name)" />
                            ...
                            <xsl:when test="@url and @urlvalue and not(@validvalues)">
                                <xsl:attribute name="ng-mouseover">
                                    <xsl:value-of
                                        select="concat('dependent(&quot;',translate(@url,'*',''),@urlvalue,'&quot;,','&quot;',@name,'&quot;)')" />
                                </xsl:attribute>
                                <xsl:attribute name="ng-options">
                                    <xsl:value-of
                                        select="concat('obj.id as obj.name for obj in ', @name)" />
                            ...
                            <xsl:when test="@url and @urlvalue and @validvalues">
                                <xsl:attribute name="ng-mouseover">
                                    <xsl:value-of
                                        select="concat('dependent(&quot;',translate(@url,'*',''),@urlvalue,'&quot;,','&quot;',@name,'&quot;,','&quot;',translate(translate($paramobjectname,'*',''),'.',''),'&quot;,','&quot;',boolean(@validvalues),'&quot;)')" />
                                </xsl:attribute>
    ...
    <xsl:template name="dropdownSpecial">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 input-field">
            <select class="dropdown-toggle1 form-control1" id="{@name}">
                ...
                <xsl:attribute name="ng-change">
                    <xsl:value-of
                        select="concat('ddChange(&quot;',translate(translate(../@name,'*',''),'.',''),'__',@name,'&quot;,',translate(translate(../@name,'*',''),'.',''),'.',@name,')')" />
                </xsl:attribute>
                <xsl:attribute name="ng-init">
                    <!--xsl:value-of
                ...
                name="ng-init" >
                    <xsl:value-of
                select="concat('dropdownUrlReq(&quot;DeviceIPInterface&quot;,','&quot;Name&quot;','&quot;','cgi_get_filterbyfirstparamval?Object=Device.IP.Interface&amp;X_LANTIQ_COM_UpStream=false&amp;Name=','&quot;',')')"/>
                </xsl:attribute-->
                <xsl:attribute name="ng-options">
            ...
            <select class="dropdown-toggle1 form-control1" id="{@name}">
                ...
                <xsl:choose>
                    <xsl:when test="@url">
                        <xsl:attribute name="ng-init">
                            <xsl:value-of
                                select="concat('jsonreq(&quot;',@name,'&quot;,','&quot;',@url,'&quot;',')')" />
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="ng-init">
                            <xsl:value-of
                                select="concat('commaremoval(&quot;',@validvalues,'&quot;,&quot;',@name,'&quot;)')" />
                        </xsl:attribute>
                        <xsl:attribute name="ng-options">
                            <xsl:value-of select="concat('obj.id as obj.name for obj in ', @name)" />
                            <xsl:if test="@order">
            ...
            <xsl:if test="@description">
                <div class="row">
                    ...
                    <span
                        class="col-lg-offset-3  col-md-offset-3 col-sm-12 col-lg-6 col-md-6 col-xs-12 descrip_txt">
                        <xsl:attribute name="ng-bind"> '<xsl:value-of
                                select="concat(../@name,'.',@webname,'.',@description)" />' |
                            translate </xsl:attribute>
                    </span>
                </div>
            </xsl:if>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <select class="dropdown-toggle1 form-control1" id="{@name}">
                        ...
                        <xsl:if test="@urldependentparent and @urldependentparam">
                            <xsl:attribute name="ng-options">
                                <xsl:value-of
                                    select="concat(@name,' for ',@name,' in ',translate(translate(@urldependentparent,'*',''),'.',''),'.',@urldependentparam,'.',@name)" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:choose>
                            <xsl:when test="@url">
                                <xsl:attribute name="ng-init">
                                    <xsl:value-of
                                        select="concat('dropdownUrlReq(&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',@url,'&quot;',')')" />
                                </xsl:attribute>
                                <xsl:attribute name="ng-options">
                                    <xsl:value-of
                                        select="concat('country for (country, ',@name,')',' in ',@name)" />
                                </xsl:attribute>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:call-template name="tokenizeString">
        ...
        <div>
            ...
            <div class="row checkbox-top-align">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                    <div class="checkbox1">
                        <input type="checkbox" ng-true-value="'true'" class="hidden-dom-removal"
                            ng-false-value="'false'">
                            <xsl:attribute name="id">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name)" />
                            </xsl:attribute>
                            <!--                            <xsl:if test="not(@Display) and (not(@required) or @required
                            !='false')">
                                <xsl:attribute name="ng-required">
                                    <xsl:choose>
                                        <xsl:when test ="@parent and @parentname  and  @depends">
        ...
        <div>
            ...
            <div class="row checkbox-top-align">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 text-left">
                    <div class="checkbox1">
                        <input type="checkbox" ng-true-value="'1'" class="hidden-dom-removal"
                            ng-false-value="'0'">
                            <xsl:attribute name="id">
                                <xsl:value-of
                                    select="concat(translate(translate($paramobjectname,'*',''),'.',''),'_',@name)" />
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 text-left">
                    ...
                    <xsl:value-of select="concat(concat(translate(../@name,'.','_'),'.',@name),'=0')"/>
                        ...
                        <xsl:if test='@dependsonparamvalue'>
                            <xsl:attribute name="ng-checked">
                                <xsl:value-of
                                    select="concat(@dependsonparamvalue,'==','$scope.ddstatus')" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:if test='@parent'>
                            <xsl:attribute name="ng-checked">
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="row">
                ...
                <div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12 input-field">
                    <!--<select
                    class="dropdown-toggle form-control" id="{@name}">-->
                    <input type="text" class="form-control" id="{@name}"
                        ...
                        <xsl:if test="@getObject">
                            <xsl:attribute name="ng-change">
                                ...
                                select="concat(translate(../@name,'.','_'),'.',@name)"/>-->
                                <xsl:value-of
                                    select="concat('resetValue(&quot;',@child,'&quot;,&quot;',@name,'&quot;,&quot;',concat(translate(translate(../@name,'*',''),'.',''),'.',@name), '&quot;)')" />
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:attribute name="name">
                            <xsl:value-of
                    ...
                    <div class="input-group-btn">
                        <button type="button" class="btn btn-default dropdown-toggle editableselect"
                            data-toggle="dropdown">
                            <span class="caret-icon">
                                <i class="fa fa-caret-down"></i>
                            </span>
                        </button>
                        <ul id="color-dropdown-menu" class="dropdown-menu dropdown-menu-right"
                            role="menu">
                            <xsl:attribute name="ng-model">
                                <xsl:value-of
                                    select="concat(translate(translate(../@name,'*',''),'.',''),'.',@name)" />
                            ...
                            <xsl:choose>
                                <xsl:when test="@url">
                                    ...
                                    <li class="input-lg">
                                        <xsl:attribute name="ng-repeat"> opt in <xsl:value-of
                                                select="@name" />
                                        </xsl:attribute>
                                        ...
                                        <a>
                                            <xsl:if test="@getObject">
                                                <xsl:attribute name="getObject">
                                                    <xsl:value-of
                                                        select="concat(@child , '-',$selectedObjectName,  @getObject)" />
                                                    <!--<xsl:text>dropdownUrlReq()</xsl:text>-->
                                                </xsl:attribute>
                                            </xsl:if>
                                            <xsl:attribute
                                                name="ng-click">
                                                <!--<xsl:value-of
                                                select="concat('selectedName(','&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',$selectedval,'&quot;)')"
                                                />-->
                                            ...
                                            <xsl:attribute
                                                name="parameters">
                                                <xsl:value-of
                                                    select="concat($selectedval,'?',@name,'?',translate(translate(../@name,'*',''),'.',''))" />
                                            </xsl:attribute>
                                            {{opt.id}} </a>
                                    </li>
                                </xsl:when>
        ...
        <xsl:choose>
            <xsl:when test="contains($list, $delimiter)">
                ...
                <li class="input-lg">
                    <a>
                        <xsl:attribute name="ng-click">
                            <!--selectedName('<xsl:value-of
                            select="substring-before($list,$delimiter)"/>')-->
                            <xsl:value-of
                                select="concat('selectedNameHard(&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;',',&quot;',substring-before($list,$delimiter),'&quot;)')" />
                            <!--<xsl:value-of
                            select="concat('selectedName(&quot;',substring-before($list,$delimiter),'&quot;)')"/>-->
                        ...
                        <li class="input-lg">
                            ...
                            <a>
                                <xsl:attribute name="ng-click">
                                    ...
                                    select="$list"/>')-->
                                    <xsl:value-of
                                        select="concat('selectedNameHard(&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;',',&quot;',$list,'&quot;)')" />
                                </xsl:attribute>
                                <xsl:value-of select="$list" />
                            </a>
                            <!--</option>-->
    ...
    <xsl:template name="requiredErrorMessage">
        ...
        <span class="error">
            <xsl:attribute name="forname">
                <xsl:value-of
                    select="concat(translate(translate($objectname,'*',''),'.',''),'_',$paramname)" />
            </xsl:attribute>
            <xsl:attribute name="ng-show">
                <xsl:value-of select="$FormName" />
                <xsl:text>_form.</xsl:text>
            ...
            <!--{{'<xsl:value-of
            select="concat($objectname,'.',$webname)"/>' | translate }} {{'required' | translate
            }}-->
            <xsl:attribute name="ng-bind"> '<xsl:value-of
                    select="concat($originalobject,'.',$webname,'.$error','.required')" />
                '|translate
            </xsl:attribute>
        </span>
    ...
    <xsl:template name="minErrorMessage">
        ...
        <span class="error">
            ...
            <!--{{'minlengthmessage'
            | translate }}  <xsl:value-of select="$minlen" />  {{'characters' | translate }}-->
            <span>
                <xsl:attribute name="ng-bind"> '<xsl:value-of
                        select="concat($originalObjectname,'.',$webname,'.$error','.minlen')" />
                    '|translate
                </xsl:attribute>
            </span>
            <span>
    ...
    <xsl:template name="maxErrorMessage">
        ...
        <span class="error">
            ...
            <!--{{'maxlengthmessage'
            | translate }}  <xsl:value-of select="$maxlength" />  {{'characters' | translate }}-->
            <span>
                <xsl:attribute name="ng-bind"> '<xsl:value-of
                        select="concat($originalObjectname,'.',$webname,'.$error','.maxlen')" />
                    '|translate
                </xsl:attribute>
            </span>
            <span>
    ...
    <xsl:template name="multiplevalues">
        ...
        <xsl:choose>
            <xsl:when test="contains($list, $delimiter)">
                <xsl:value-of
                    select="concat(translate(translate($dependsobjectname,'.',''),'*',''),'.',$dependsparamname,'==',substring-before($list,$delimiter),' || ' )" />
                <xsl:call-template name="multiplevalues">
                    <xsl:with-param name="list" select="substring-after($list,$delimiter)" />
                    <xsl:with-param name="delimiter" select="$delimiter" />
            ...
            <xsl:otherwise>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:value-of
                            select="concat(translate(translate($dependsobjectname,'.',''),'*',''),'.',$dependsparamname,'==',$list)" />
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <div>
            ...
            <div class="row checkbox-top-align">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 text-left radiogroup">
                    ...
                    class="checkbox1 ">-->
                    <p>
                        <xsl:attribute name="ng-repeat"> value in <xsl:value-of
                                select="concat('radiofunction(&quot;',@validvalues,'&quot;)')" />
                        </xsl:attribute>
        ...
        <div class="panel panel-default panel-bg1">
            ...
            <xsl:if test="@title">
                <div class="panel-heading blu_bg">
                    ...
                    <span>
                        <xsl:attribute name="ng-bind"> '<xsl:value-of select="@title" />' |
                            translate </xsl:attribute>
                    </span>
                </div>
            </xsl:if>
            <div class="panel-body no-padding">
                    ...
                    <xsl:for-each select=". | object">
                        <xsl:if test="@name">
                            <xsl:value-of select="@name" />?<xsl:for-each
                                select="parameter | row/col/parameter">
                                <xsl:choose>
                                    <xsl:when test="name(parent::*)='col'">
                                        <!--<xsl:if
                                        test="@type != 'button' and  @Display='No' and
                                        not(../../../@parent)" >-->
                                        <!--                                        <xsl:if test="@type != 'pushbutton' and @type !=
                                        'button' and  @Value and not(../../../@dependsonparamvalue)"
                                        >
                                        ...
                                        <xsl:if
                                            test="@type != 'pushbutton' and @type != 'button' and  @Value and not(../../../@parent) and not(../../../@dependsonparamvalue)">
                                            <xsl:value-of select="@name" />__<xsl:value-of
                                                select="@Value" />
                                            <xsl:if
                                                test="position() != last()">
                                                <xsl:text>,</xsl:text>
                ...
                <xsl:variable name="hiddendropdownfields">
                    <xsl:for-each select=". | object">
                        <xsl:if test="@dependsonparam">
                            <xsl:for-each
                                select="parameter[@type='dropdown' and not(@validvalues)] | row/col/parameter[@type='dropdown' and not(@validvalues)]">
                                <xsl:choose>
                                    <xsl:when test="name(parent::*)='col'">
                                        <xsl:value-of
                                            select="concat('dropdownUrlReq(&quot;',translate(translate(../../../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',@url,'&quot;,','&quot;',boolean(@ddfun),'&quot;,&quot;',@firstselect,'&quot;,&quot;',@urlparam,'&quot;',')')" />
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:value-of
                                            select="concat('dropdownUrlReq(&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',@url,'&quot;,','&quot;',boolean(@ddfun),'&quot;,&quot;',@firstselect,'&quot;,&quot;',@urlparam,'&quot;',')')" />
                ...
                <div class="alert alert-danger">
                    <xsl:attribute name="ng-show">
                        <xsl:value-of
                            select="concat(translate(translate($objectname,'*',''),'.',''),'popup')" />
                    </xsl:attribute>
                    <a class="close" aria-label="close">
                        <xsl:attribute name="ng-click">
                            <xsl:value-of
                                select="concat('popupclose(&quot;',translate(translate($objectname,'*',''),'.',''),'popup','&quot;)')" />
                        ;
                        </xsl:attribute>&#10006; </a>
                    <p>
                        <xsl:attribute name="ng-bind-html">
                            <xsl:value-of
                                select="concat(translate(translate($objectname,'*',''),'.',''),'popupval',' | unsafe')" />
                        </xsl:attribute>
                    </p>
                </div>
                <!-- onload=="false" (in XML), 
                ...
                <form polling="{@polling}" interval="{@interval}" loadstatus="{@onload}"
                    class="form-horizontal formCount lantiq-form-text">
                    <xsl:attribute name="ng-init">
                        <xsl:value-of select="$hiddendropdownfields" />
                    </xsl:attribute>
                    <xsl:attribute name="name">
                        <xsl:value-of
                            select="concat(translate(translate($objectname,'*',''),'.',''),'_form')" />
                    </xsl:attribute>
                    ...
                    <div class="">
                        <xsl:for-each select=". | object">
                            <xsl:if
                                test="position() = 1 or  (count(parameter) - count(parameter[@type = 'submitbutton']) > 0) or (count(row/col/parameter)-count(row/col/parameter[@type = 'submitbutton'])>0)">
                                <xsl:variable name="individualbutton">
                                    <xsl:value-of select="@name" />?<xsl:for-each
                                        select="parameter | row/col/parameter">
                                        <xsl:if
                                            test="@type != 'pushbutton' and @type != 'button' and @type != 'label' and @type != 'description'">
                                            <xsl:value-of select="@name" />
                                            <xsl:if test="position() != last()">
                                                <xsl:text>,</xsl:text>
                                            </xsl:if>
                                ...
                                <div class="wrapperdiv">
                                    ...
                                    <xsl:if test="@title and position() != 1">
                                        <div class="panel-heading blu_bg">
                                            ...
                                            <xsl:attribute name="ng-bind"> '<xsl:value-of
                                                    select="@title" />' | translate </xsl:attribute>
                                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <xsl:if test="@subtitle">
                                            <h4>
                                                <xsl:attribute name="ng-bind"> '<xsl:value-of
                                                        select="@subtitle" />' | translate </xsl:attribute>
                                            </h4>
                                        </xsl:if>
                                            ...
                                            <xsl:if test="@type = &apos;eventbutton&apos;">
                                                <xsl:call-template name="eventbutton">
                                                    <xsl:with-param name="param"
                                                        select="$individualbutton" />
                                                    <xsl:with-param name="formname">
                                                        <xsl:value-of
                                                            select="translate(translate($objectname,'*',''),'.','')" />
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                            </xsl:if>
                                            <xsl:if test="@type = &apos;string&apos;">
                                                <xsl:call-template name="string">
                                                    ...
                                                    <xsl:with-param name="parentobjectparent">
                                                        <xsl:choose>
                                                            <xsl:when
                                                                test="../@dependsonparamvalue or ../../../@dependsonparamvalue">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="name(parent::*)='col'">
                                                                        <xsl:value-of
                                                                            select="../../../@dependsonparamvalue" />
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                    ...
                                                    <xsl:with-param name="parentobjectparentname">
                                                        <xsl:choose>
                                                            <xsl:when
                                                                test="../@dependsonobject or ../../../@dependsonobject">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="name(parent::*)='col'">
                                                                        <xsl:value-of
                                                    ...
                                                    <xsl:with-param name="parentobjectdepends">
                                                        <xsl:choose>
                                                            <xsl:when
                                                                test="../@dependsonparam or ../../../@dependsonparam">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="name(parent::*)='col'">
                                                                        <xsl:value-of
                                                            ...
                                                            <xsl:when
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="name(parent::*)='col'">
                                                                        <xsl:value-of
                                                                            select="boolean(../../../@dependsonparamvalue)" />
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:value-of
                                                                            select="boolean(../@dependsonparamvalue)" />
                                                    ...
                                                    <xsl:with-param
                                                        name="parentobjectparentnamestatus">
                                                        <xsl:choose>
                                                            <xsl:when
                                                                test="../@dependsonobject or ../../../@dependsonobject">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="name(parent::*)='col'">
                                                                        <xsl:value-of
                                                                            select="boolean(../../../@dependsonobject)" />
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:value-of
                                                                            select="boolean(../@dependsonobject)" />
                                ...
                                <xsl:if test="@type = &apos;submitbutton&apos;">
                                    <xsl:call-template name="button1">
                                        ...
                                        <xsl:with-param name="param3"
                                            select="translate(translate($relationobjectname,'*',''),'.','')" />
                                    </xsl:call-template>
                                </xsl:if>
    ...
    <xsl:template match="object[@viewtype='table']">
        ...
        <div class="panel">
            ...
            <xsl:variable name="obj-param-type">
                <xsl:for-each select="./parameter | object/parameter">
                    <xsl:if test="@type != 'pushbutton' and @type != 'button'">
                        <xsl:value-of select="translate(translate(../@name,'*',''),'.','')" />__<xsl:value-of
                            select="@name" />__<xsl:value-of select="@type" />
                        <xsl:if
                            test="position() != last()">
                            <xsl:text>,</xsl:text>
                        </xsl:if>
            ...
            <div class="panel-body">
                <div class="table-responsive table-scroll-vr">
                    <table polling="{@polling}" loadstatus="{@onload}" interval="{@interval}"
                        class="table table-bordered tableCount theme_intel" formname="{@form}"
                        name="{@name}">
                        <xsl:attribute name="name">
                                        ...
                                        <th id="{@name}">
                                            <xsl:choose>
                                                <xsl:when test="@Display">
                                                    <xsl:attribute name="ng-init">
                                                        <xsl:value-of
                                                            select="concat(translate(translate($objectname,'*',''),'.',''),position(),'=','false')" />
                                                        <!-- multple=="true", To create multiple
                                                        rows for multiple child objects in table  -->
                                                        <xsl:if test="@multiple='true'">
                                                            <xsl:value-of
                                                                select="concat(translate(translate($objectname,'*',''),'.',''),'_multiple','=','true')" />
                                                            ;
                                                    </xsl:if>
                                                    </xsl:attribute>
                                                    <xsl:attribute name="ng-hide">
                                                ...
                                                <xsl:when test="not(@Display)">
                                                    <xsl:choose>
                                                        <xsl:when test="@type='dropdown1'">
                                                            <xsl:attribute name="ng-init">
                                                                <xsl:value-of
                                                                    select="concat(translate(translate($objectname,'*',''),'.',''),position(),'=','true')" />
                                                                ;<xsl:value-of
                                                                    select="concat('dropdownUrlReq(&quot;',translate(translate(../@name,'*',''),'.',''),'&quot;,','&quot;',@name,'&quot;,','&quot;',@url,'&quot;,&quot;&quot;,&quot;&quot;,&quot;',@urlparam,'&quot;',')')" />	
                                                            <xsl:if
                                                                    test="@multiple='true'">
                                                                    <xsl:value-of
                                                                        select="concat(translate(translate($objectname,'*',''),'.',''),'_multiple','=','true')" />
                                                        ...
                                                        <xsl:when test="@iconicurl">
                                                            <xsl:attribute name="ng-init">
                                                                <xsl:value-of
                                                                    select="concat(translate(translate($objectname,'*',''),'.',''),position(),'=','true')" />
                                                                ;<xsl:value-of
                                                                    select="concat('jsonreq(&quot;',@name,'&quot;,','&quot;',@iconicurl,'&quot;',')')" />
                                                                ;<xsl:value-of
                                                                    select="concat(@name,'displaystatus','=','false')" />
                                                                ;	
                                                            <xsl:if
                                                                    test="@multiple='true'">
                                                                    <xsl:value-of
                                                        ...
                                                        <xsl:otherwise>
                                                            <xsl:attribute name="ng-init">
                                                                ...
                                                                ;<xsl:value-of
                                                                    select="concat(translate(translate($objectname,'*',''),'.',''),position(),'=','true')" />
                                                                ;<xsl:value-of
                                                                    select="concat(@name,'displaystatus','=','true')" />
                                                                ;
                                                            <xsl:if
                                                                    test="@multiple='true'">
                                                                    <xsl:value-of
                            ...
                            <tr>
                                <xsl:choose>
                                    <xsl:when test="@pagination='true'">
                                        <xsl:attribute name="ng-repeat"> user in <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'table')" />
                                            | startFrom:currentPage*pageSize | limitTo:pageSize </xsl:attribute>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:attribute name="ng-repeat"> user in <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'table')" />
                                ...
                                <td ng-if="false==$last">
                                    <xsl:attribute name="ng-repeat"> key in user | keys:'<xsl:value-of
                                            select="concat(translate(translate($objectname,'*',''),'.',''),'')" />
                                        '
                                </xsl:attribute>
                                    <xsl:attribute name="ng-show">
                                        <xsl:value-of
                                    ...
                                    <span>
                                        ...
                                        <span>
                                            ...
                                            {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                                    </span>
                                </td>
                                <xsl:if test="parameter/@name='edit' or parameter/@name='delete'">
                                    <td ng-repeat="td in user" ng-if="true==$last"
                                        class="table-button-group">
                                        <xsl:if test="parameter/@name='connect'">
                                            <button class="btn table-btn-txt">
                                                <xsl:attribute name="ng-init">
                                                    checkButtonState(user, <xsl:value-of
                                                        select="concat('&quot;',$connectdependsonparam,'&quot;,&quot;',$connectdependsonparamvalue, '&quot;)')"></xsl:value-of>
                                                </xsl:attribute>
                                                <xsl:attribute name="ng-click">
                                                    <xsl:value-of select="$connectValue" />
                                                </xsl:attribute>
                                                <xsl:attribute name="ng-class">
                                                    {btn_bg_color_grn: {{'connect' +
                                                    user.objectIndex}},btn_bg_color_red:
                    ...
                    <xsl:if test="@pagination='true'">
                        <div class="pull-right">
                            <button class="btn btn-sm btn-info" ng-disabled="currentPage == 0"
                                ng-click="currentPage=currentPage-1">
                                Previous
                            </button>
                            {{currentPage+1}}/{{numberOfPages}} <button class="btn btn-sm btn-info"
                                ng-disabled="currentPage >= tablesize/pageSize - 1"
                                ng-click="currentPage=currentPage+1">
                                Next
                            </button>
                        </div>
                        <div class="pull-left">
                            <select class="btn btn-primary dropdown-toggle"
                                style="width:40px;height:30px !important" name="pageSize"
                                ng-model="pageSize">
                                <xsl:attribute name="ng-change">
                                    <xsl:value-of
                                        select="concat('changeNumberOfPages(&quot;',translate(translate($objectname,'*',''),'.',''),'','table&quot;)')" />
                                </xsl:attribute>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 text-right">
                <xsl:for-each select="parameter">
                    <xsl:if
                        test="@type = &apos;button&apos; and @name != &apos;edit&apos; and @name != &apos;delete&apos; and @name != &apos;view&apos; and @name != &apos;download&apos;  and @name != &apos;connect&apos;">
                        <xsl:call-template name="button" />
                    </xsl:if>
                </xsl:for-each>
            </div>
    ...
    <xsl:template match="object[@viewtype='tablePlus']">
        ...
        <div>
            ...
            <div class="panel">
                ...
                <xsl:variable name="obj-param-type">
                    <xsl:for-each select="./parameter | object/parameter">
                        <xsl:value-of select="translate(translate(../@name,'*',''),'.','')" />__<xsl:if
                            test="@type != 'pushbutton' and @type != 'button'">
                ...
                <div class="alert alert-danger">
                    ...
                    <xsl:attribute name="ng-init">
                        <xsl:value-of
                            select="concat(translate(translate($objectname,'*',''),'.',''),'popup','=false')" />
                    </xsl:attribute>
                ...
                <div class="panel-body">
                    <div class="table-responsive table-scroll-vr">
                        <form class="add-ip-addr-form">
                            ...
                            <table class="add-ip-addr table-bordered">
                                <tr>
                                    <xsl:attribute name="ng-show">
                                        <xsl:value-of
                                            select="concat(translate(translate($objectname,'*',''),'.',''),'showstatus')" />
                                    </xsl:attribute>
                                    <xsl:for-each select="parameter | object/parameter">
                                        <xsl:if test="@type != 'pushbutton' and @type != 'button'">
                                    ...
                                    <td class="table-button-group">
                                        <xsl:for-each
                                            select="parameter[@name='Add'] | object/parameter[@name='Add']">
                                            <a class="btn table-btn" componenttype="{../@viewtype}"
                                                data-ng-click="{./@routeurl}">
                                            ...
                                            <a
                                                ...
                                                <xsl:attribute name="ng-click">
                                                    <xsl:value-of
                                                        select="concat('rowcancel(&quot;',translate(translate($objectname,'*',''),'.',''),'showstatus','&quot;)')" />
                                                </xsl:attribute>
                        ...
                        <table class="table table-bordered tableCount theme_intel "
                            formname="{@form}" buttonstatus="{@buttons}">
                            <xsl:attribute name="name">
                                <xsl:copy-of select="$name" />
                            </xsl:attribute>
                            <xsl:attribute name="objparamrelation">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <xsl:if
                                        test="parameter/@name='edit' or parameter/@name='delete' or parameter/@name='Add'">
                                                ...
                                                <a id="{@name}" class="btn btn-sm btn-info">
                                                    <xsl:attribute name="ng-click">
                                                        <xsl:choose>
                                                            <xsl:when test="@limit">
                                                                <xsl:value-of
                                                                    select="concat('limit(&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;)')" />
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                <xsl:value-of
                                                                    select="concat('editabletableformdisplaystatus(&quot;',translate(translate($objectname,'*',''),'.',''),'showstatus','&quot;)')" />
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </xsl:attribute>
                            ...
                            <tbody id="bodyData">
                                <xsl:attribute name="ng-class">
                                    <xsl:value-of
                                        select="concat(translate(translate($objectname,'*',''),'.',''),'showstatus')" />==true
                                    ? 'showrow' : 'hiderow' </xsl:attribute>
                                ...
                                <tr ng-init="sectionIndex = $index">
                                    ...
                                    <td ng-if="false==$last">
                                        ...
                                        <xsl:attribute
                                                name="e-ng-blur">
                                            textchangeEditable1(key,$data,user.z,<xsl:value-of
                                                    select="concat('&quot;',$objectname,'&quot;')" />
                                            ,sectionIndex+1)
                                        </xsl:attribute>
                                            {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                                    ...
                                    <td ng-repeat="(key, value) in user" ng-if="true==$last"
                                        style="display:none">
                                        <span e-form="rowform">
                                    ...
                                    <xsl:if
                                        ...
                                        <td class="table-button-group no-padding-hr">
                                            <form name="rowform" ng-show="rowform.$visible"
                                                class="form-buttons form-inline editable-form"
                                                shown="inserted == user">
                                                <!--                                            <xsl:attribute name="formname">
                                            ...
                                            <button
                                                ...
                                                &#xA0;&#xA0;&#xA0;
                                            <button
                                                    type="button" ng-disabled="rowform.$waiting"
                                            ...
                                            <div class="buttons" ng-show="!rowform.$visible">
                                                ...
                                                <xsl:if test="parameter/@name='delete'">
                                                    <button class="btn table-btn"
                                                        data-ng-click="delete($event,user)">
                                                        <xsl:attribute name="popupinfo">
                                                            <xsl:value-of
                                                                select="translate(translate($objectname,'*',''),'.','')" />
                                                        </xsl:attribute>
                                                        ...
                                                        <i class="fa fa-trash-o btn_color_red"></i>
                                                    </button>
                                                </xsl:if>
                                            </div>
                                        </td>
            ...
            <xsl:for-each select="parameter">
                <xsl:if
                    test="@type = &apos;button&apos; and @name != &apos;edit&apos; and @name != &apos;delete&apos; and @name != &apos;Add&apos;">
                    <xsl:call-template name="button" />
                </xsl:if>
            </xsl:for-each>
    ...
    <xsl:template match="object[@viewtype='EditableTable']">
        <div class="panel panel-default panel-bg1">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive table-scroll-vr">
                    <table class="table table-bordered tableCount" componentviewtype="{@viewtype}"
                        formname="{@form}" buttonstatus="{@buttons}">
                        <xsl:if test="@dependsonparam and @dependsonobject">
                            <xsl:attribute name="ng-show">
                                <xsl:value-of
                        ...
                        <xsl:if test="@depends and @parentname">
                            <xsl:attribute name="ng-show">
                                <xsl:value-of
                                    select="concat(translate(translate(@parentname,'.',''),'*',''),'.',@depends,'!=')" />
                                <xsl:text>undefined</xsl:text>
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:attribute name="name">
                        ...
                        <tbody id="bodyData">
                            <tr>
                                        ...
                                        <xsl:if test="not(@Display)">
                                            <td>
                                                <form class="add-ip-addr-form">
                                                    <xsl:attribute name="name">
                                                        <xsl:value-of
                                                            select="concat(translate(translate($objectname,'*',''),'.',''),'_editabletableform')" />
                                                    </xsl:attribute>
                                                    <xsl:if test="@type = &apos;stringA&apos;">
                                                        <xsl:call-template name="stringA" />
                                                    </xsl:if>
                                                    ...
                                                    <xsl:if test="@type = &apos;macaddress&apos;">
                                                        <xsl:call-template name="macaddress">
                                                            ...
                                                            <xsl:with-param
                                                                name="paramoriginalobjectname">
                                                                <xsl:value-of
                                                                    select="../@originalobject" />
                                                            </xsl:with-param>
                                                            <xsl:with-param
                                                                name="parentobjectparent">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="../@dependsonparamvalue or ../../../@dependsonparamvalue">
                                                                        <xsl:value-of
                                                            ...
                                                            <xsl:with-param
                                                                name="parentobjectdependsstatus">
                                                                <xsl:choose>
                                                                    <xsl:when
                                                                        test="../@dependsonparam or ../../../@dependsonparam">
                                                                        <xsl:value-of
                                ...
                                <td style="vertical-align: middle;">
                                    <a class="btn table-btn" source="{@viewtype}"
                                        data-ng-click="macrowApply($event)">
                                        <xsl:attribute name="showstatus">
                                            <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'showstatus')" />
                                        </xsl:attribute>
                            ...
                            <tr ng-init="sectionIndex = $index">
                                ...
                                <xsl:if
                                    test="parameter/@name='edit' or parameter/@name='delete' or parameter/@name='Add'">
                                    <td>
                                        <form name="rowform" onaftersave="editableApply($data)"
                                            ...
                                            <button
                                                type="button" ng-disabled="rowform.$waiting"
                                                ng-click="rowform.$cancel()" class="btn btn-info">
                                                <xsl:attribute name="name">
                                                    <xsl:text>cancel</xsl:text>
                                                </xsl:attribute>
                                                <xsl:text>cancel</xsl:text>
    ...
    <xsl:template match="object[@viewtype='rowtable']">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive table-scroll-vr">
                    <table class="table table-bordered tableCount theme_intel"
                        componenttype="{@viewtype}" name="{@name}">
                        <xsl:attribute name="name">
                            <xsl:copy-of select="$name" />
                        </xsl:attribute>
                        <xsl:attribute name="id">
                        ...
                        <tbody id="bodyData">
                            <tr ng-if="false==$last">
                                <xsl:attribute name="ng-repeat"> (key,value) in <xsl:value-of
                                        select="concat(translate(translate($objectname,'*',''),'.',''),'table')" />
                                    <xsl:text>[0]</xsl:text>
                                </xsl:attribute>
        ...
        <div class="row">
            <div class="col-lg-12">
                <xsl:for-each select="parameter">
                    <xsl:if
                        test="@type = &apos;button&apos; and @name != &apos;edit&apos; and @name != &apos;delete&apos;">
                        <xsl:call-template name="button" />
                    </xsl:if>
                </xsl:for-each>
            </div>
                    ...
                    <li>
                        ...
                        <a data-toggle="tab" aria-expanded="false">
                            ...
                            <xsl:attribute name="href">
                                <xsl:value-of
                                    select="concat('#',translate(translate(@title,'.$',''),' ',''))" />
                            </xsl:attribute>
                            <xsl:value-of select="@title" />
                        </a>
                    </li>
    ...
    <xsl:template match="object[@viewtype='accordionComponent']">
        <div class="panel panel-default panel-bg1">
            <h2>
                <xsl:attribute name="ng-bind"> '<xsl:value-of select="@title" />' | translate </xsl:attribute>
            </h2>
            <xsl:variable name="objectname">
                <xsl:if test="@name">
                    <xsl:value-of select="@name" />
            ...
            <div class="panel-body">
                <table class="table table-bordered theme_intel">
                    ...
                    <tbody ng-init="sectionIndex = $index">
                        <!--<xsl:for-each
                        select="parameter | object/parameter">-->
                        <xsl:attribute name="ng-repeat"> user in <xsl:value-of
                                select="concat(translate(translate($objectname,'*',''),'.',''),'table')" />
                        </xsl:attribute>
                        <tr class="main-row">
                            ...
                            <td>
                                <!--<button
                                class="btn btn-info" ng-click="accordiontabledetail($index,$event)"
                                ng-init="toggleText[$index] = 'More'">-->
                                <button class="btn btn-info"
                                    ng-click="accordiontabledetail($index,$event)">
                                    <xsl:attribute name="ng-init">
                                        <xsl:value-of
                                            select="concat(translate(translate($objectname,'*',''),'.',''),'toggle')" />
                                    [$index]='More'
                                    </xsl:attribute>
                                    <xsl:attribute
                                        name="source">
                ...
                <table class="table table-bordered theme_intel">
                    ...
                    <xsl:for-each select="parameter">
                        <tbody>
                            <tr class="main-row">
                                <td>
                                    <xsl:attribute name="ng-bind"> '<xsl:value-of select="@webname" />
                                        '|translate </xsl:attribute>
                                </td>
                                <td>
                                    <button class="btn btn-info">
                                        <xsl:attribute name="ng-init">
                                            ...
                                            <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'toggle')" />
                                        [<xsl:value-of select="position()" />]='More' </xsl:attribute>
                                        <xsl:attribute
                                            name="ng-click">
                            ...
                            <tr class="extra-row">
                                <xsl:attribute name="ng-show">
                                    <xsl:value-of
                                        select="concat(translate(translate($objectname,'*',''),'.',''),'accordion')" />
                                    <xsl:text>==</xsl:text>
                                    <xsl:value-of select="position()" />
                                </xsl:attribute>
                                <td colspan="2">
    ...
    <xsl:template match="object[@viewtype='accordion']">
        <div class="panel panel-default panel-bg1">
            ...
            <div class="panel-body">
                <table class="table table-bordered theme_intel table-column-4"
                    loadstatus="{@onload}">
                    <xsl:attribute name="name">
                        <xsl:copy-of select="$name" />
                    </xsl:attribute>
                    ...
                    <xsl:variable name="hiddenparams">
                        <xsl:for-each select="parameter | object/parameter">
                            <xsl:if test="@type !='button' and @Display">
                                <xsl:value-of select="../@name" />?<xsl:value-of select="@name" />__<xsl:value-of
                                    select="@Value" />
                                <xsl:if test="position() != last()">
                                    <xsl:text>&amp;</xsl:text>
                                </xsl:if>
                    ...
                    <thead>
                        <tr>
                            ...
                            <xsl:if test="parameter/@name='Add'">
                                <th>
                                    <a id="{parameter/@name}" name="{parameter/@name}"
                                        class="btn btn-sm btn-info">
                                        <xsl:attribute name="ng-click">
                                            <xsl:value-of
                                                select="concat('editabletableformdisplaystatus(&quot;',translate(translate($objectname,'*',''),'.',''),'showstatus','&quot;,&quot;',$AccordionObj,'&quot;)')" />
                                        </xsl:attribute>

                                        <!--                                        <xsl:attribute name="ng-click">
                                            tableplusAddAccordion(<xsl:value-of
                                        select="concat('&quot;',translate(translate($name,'*',''),'.',''),'&quot;')"
                                        />)
                                        </xsl:attribute>-->
                                        <i class="fa fa-plus table_plusicon"></i>
                                        <span>
                                            <xsl:attribute name="ng-bind">
                                                ' Add' | translate
                                            </xsl:attribute>
                        ...
                        <tr ng-form="myForm" ng-submit="submitQuery()">
                            ...
                            <td style="vertical-align:middle">
                                <a style="position:relative;"
                                    class="fa fa-check btn_color_grn btn btn-xs table-btn"
                                    source="{@viewtype}">
                                    <input type="button" class="btn btn-xs table-btn"
                                        style="position: absolute;top: -5px; left: -6px;">
                                        <xsl:attribute name="showstatus">
                                            <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'showstatus')" />
                                        </xsl:attribute>
                                        <xsl:attribute name="data-ng-click"> addObject(<xsl:value-of
                                                select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;,','&quot;',$AccordionObj,'&quot;')" />
                                ,$event);Apply($event,true,<xsl:value-of
                                                select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')" />
                                )
                                    </xsl:attribute>
                                        <xsl:attribute name="ng-disabled">
                    ...
                    <tbody ng-init="sectionIndex = $index">
                        ...
                        <tr class="main-row">
                            <td ng-if="false==$last">
                                ...
                                <span e-form="rowform">
                                    <xsl:attribute name="ng-if">
                                        <xsl:text>'stringA' == elementtype(</xsl:text>key<xsl:text>)</xsl:text>||<xsl:text>'passwordA' == elementtype(</xsl:text>
                                    key<xsl:text>)</xsl:text>
                                    </xsl:attribute>
                                    <xsl:attribute
                                        name="editable-text">
                                    user.{{key.split('__')[0]+"__"+key.split('__')[1]}}
                                    ...
                                    <xsl:attribute
                                        name="e-ng-blur"> textchangeEditable(key,$data,user.z,<xsl:value-of
                                            select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')" />
                                    ,sectionIndex)
                                    </xsl:attribute>
                                    {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                                ...
                                <span e-form="rowform">
                                    ...
                                    <xsl:attribute
                                        name="e-ng-change"> dropdownchangeEditable(key,$data,user.z,<xsl:value-of
                                            select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')" />
                                    ,sectionIndex)
                                    </xsl:attribute>
                                    {{urldropdownvalue(keyname(key),user[key.split('__')[0]+"__"+key.split('__')[1]])}}
                                ...
                                <span e-form="rowform">
                                   ...
                                   <xsl:attribute
                                    ...
                                    <xsl:attribute
                                        name="e-ng-false-value">
                                        'false'
                                    </xsl:attribute>
                                    <xsl:attribute
                                        name="e-ng-change"> checkboxchangeEditable(key,$data,user.z,<xsl:value-of
                                            select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')" />
                                    ,sectionIndex)
                                    </xsl:attribute>
                                    {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                            ...
                            <!--<xsl:if
                            test="parameter/@name='edit' or parameter/@name='delete' or
                            parameter/@name='Add'">-->
                            <td style="vertical-align:middle">
                                <xsl:if test="parameter/@name='delete'">
                                    <button ng-init="rowform.$show()" class="btn table-btn">
                                        <!--data-ng-click="remove($index)"-->
                                        <xsl:attribute name="ng-click"> removeRow(<xsl:value-of
                                                select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')" />
                                            ,$index)
                                        </xsl:attribute>
                                        <xsl:attribute name="id">
                            ...
                            <td>
                                <!--<button
                                class="btn btn-info"
                                ng-click="accordionformdetailtoggleDetail($index,$event)"
                                ng-init="toggleText[$index] = 'More'">-->
                                <button class="btn btn-info"
                                    ng-click="accordionformdetail($index,$event)">
                                    <xsl:attribute name="ng-init">
                                        <xsl:value-of
                                            select="concat(translate(translate($objectname,'*',''),'.',''),'toggle')" />
                                    [$index]='More'
                ...
                <form name="rowform" onaftersave="bulkapply()"
                    class="form-buttons form-inline editable-form">
                    <!--    
                    ...
                    <xsl:if test="not(@nolocaladdapply)">
                        <div class="btn-form text-right" ng-show="rowform.$visible"
                            ng-init="rowform.$visible = 'true'">
                    ...
                    <tbody ng-init="sectionIndex = $index">
                        ...
                        <tr class="main-row">
                            <td ng-if="false==$last">
                                ...
                                <span e-form="rowform">
                                    <xsl:attribute name="ng-if">
                                        <xsl:text>'string' == elementtype(</xsl:text>key<xsl:text>)</xsl:text>||<xsl:text>'dual' == elementtype(</xsl:text>
                                    key<xsl:text>)</xsl:text>
                                    </xsl:attribute>
                                    {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                                <span e-form="rowform">
                                ...
                                <span e-form="rowform">
                                   ...
                                   <xsl:attribute
                                    ...
                                    <!--xsl:attribute
                                    name="e-ng-change">
                                       checkboxchangeEditable(key,$data,user.z,<xsl:value-of
                                    select="concat('&quot;',translate(translate($objectname,'*',''),'.',''),'&quot;')"/>,sectionIndex)
                                    </xsl:attribute-->
                                    {{user[key.split('__')[0]+"__"+key.split('__')[1]]}} </span>
                            </td>
                            <td ng-repeat="(key, value) in user" ng-if="true==$last"
    ...
    <xsl:template match="view">
      ...
      <i
                                    class="fa fa-home"></i> {{breadcrumb.name}} </a>
                        </div>
                    </div>
                    <div class="btn-group btn-breadcrumb" ng-switch-when="false">
                        <span class="btn btn-default not-active"
                            ng-if="breadcrumb.path=='nothing' || $last==true">
                            {{breadcrumb.name}}
                        </span>
        ...
        <xsl:if test="boolean(./helptext)">
            <xsl:variable name="helpkey">{{'<xsl:value-of select="concat(@viewid,'.','helpkey')" />'
                | translate}}</xsl:variable>
            <div class="help_toggle helpshow" ng-init="scopevariable=true"
                ng-class="scopevariable ? 'helpshow' : 'helphide'">
        ...
        <xsl:if test="boolean(./helptour)">
            ...
            <div class="help_tour_toggle helpshow" ng-init="scopevariable=true">
                <div class="help_txtcontent">
                    ...
                    <a href="">
                        <xsl:attribute name="ng-click"> startTour(<xsl:value-of select="$helpkey" />
                            )
                        </xsl:attribute>
    ...
    <xsl:template match="object[@viewtype='tableaccordion']">
            ...
            <div class="panel-body">
                <table class="table table-bordered theme_intel">
                    ...
                    <tbody ng-init="sectionIndex = $index">
                        <!--<xsl:for-each
                        select="parameter | object/parameter">-->
                        <xsl:attribute name="ng-repeat"> (userkey, user) in <xsl:value-of
                                select="concat(translate(translate($objectname,'*',''),'.',''),'table')" />
                        </xsl:attribute>
                        <tr class="main-row">
                            <td ng-repeat="key in user | keys" ng-if="false==$last">
                            ...
                            <xsl:if test="parameter/@name='edit' or parameter/@name='delete'">
                                <td ng-repeat="td in user" ng-if="true==$last"
                                    ...
                                    <button class="btn btn-info"
                                        ng-click="accordiontableload(userkey,$event)">
                                        <xsl:attribute name="ng-init">
                                            <xsl:value-of
                                                select="concat(translate(translate($objectname,'*',''),'.',''),'toggle')" />
                                        [userkey]='More'
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 text-right">
                <xsl:for-each select="parameter">
                    <xsl:if
                        test="@type = &apos;button&apos; and @name != &apos;edit&apos; and @name != &apos;delete&apos; and @name != &apos;view&apos; and @name != &apos;download&apos;">
                        <xsl:call-template name="button" />
                    </xsl:if>
                </xsl:for-each>
            </div>
