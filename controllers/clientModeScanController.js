myapp.controller("clientModeScanController", function ($scope, $http, $route, $routeParams, localStorageService, modifyService, $translate, $rootScope, $interval, clientModeService, TOKEN_MISMATCH_CODE) {
        ...
        var setData = function(){
            ...
            var data = setParams;
                ...
                $http.get(URL + post).
                    ...
                    else if (response.status === TOKEN_MISMATCH_CODE){
                        setData();
                    }
                        ...
                        if (response.data.Objects.length < 2 && response.data.Objects[0].Param.length < 2) {
                            $scope["clientmodescan" + "popup"] = true;
                            $scope["clientmodescan" + "popupval"] = response.data.Objects[0].Param[0].ParamValue;
                        }
                        else {
                             var popupvalue = '';
