...
angular.module('xeditable').directive('editableCheckbox', ['editableDirectiveFactory',
  function(editableDirectiveFactory) {
    return editableDirectiveFactory({
      ...
      render: function() {
        this.parent.render.call(this);
         //Added a parameter eFor as it is mandatory in the webui framework to bind the original checkbox to the materialize css checkbox in order for the checkbox to show and work. eFor will have the id of the original checkbox and will be bound to it.
          var html =  '<label';  
              if(this.attrs.eFor) {
                   html = html + ' for=' +this.attrs.eFor;   
                      if(this.attrs.eTitle) {
                          html = html + ' ng-bind=' + this.attrs.eTitle;
                      }
              }
              html = html + '></label>';
              this.inputEl.after(html);
      },
      autosubmit: function() {
        var self = this;
